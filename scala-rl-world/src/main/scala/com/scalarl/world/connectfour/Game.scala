...
object Game {
  ...
  /** Represents the color of a game piece. Board positions are represented with Option[Color.]
    */
  ...
  /** Represents a user-generated attempt to drop a piece of `color` onto the column `column`.
    */
  ...
  class Board(
    ...
    /** Returns true if the position lies within the bounds of this board, false otherwise.
      */
  ...
  object Board {
    ...
    case class Position(row: Row, column: Column) {
      ...
      /** Returns a list of positions achieved by walking the position using the supplied function.
        */
