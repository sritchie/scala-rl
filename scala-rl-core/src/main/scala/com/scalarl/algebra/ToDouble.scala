...
/**
  Typeclass that encodes how some type A can be converted into a Double
  instance.
  */
...
object ToDouble {
  ...
  /**
    Any type A that conforms to the Numeric typeclass can be converted to double
    via the toDouble method on that typeclass.
    */
