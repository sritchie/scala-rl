...
object Evaluator {
  ...
  /**
    Builder class that manages conversion of an [[evaluate.StateValue]]
    instance into either an [[evaluate.ActionValue]] or
    [[evaluate.StateValue]] instance.
    */
  ...
  /**
    Builder class that manages conversion of an [[evaluate.ActionValue]]
    instance into either an [[evaluate.ActionValue]] or
    [[evaluate.StateValue]] instance.
    */
